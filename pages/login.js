          ...
          <div className="mb-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full p-2 rounded-full mt-5 font-popin ${
                  isLoading
                    ? "bg-black text-xs md:text-base text-white cursor-not-allowed"
                    : "bg-white border border-black text-xs md:text-base text-black hover:text-white hover:bg-black hover:border-transparent"
                }`}
                disabled={isLoading}
              >
            ...
            <div className="flex flex-col">
              <button
                ...
                className="flex flex-row text-xs md:text-base items-center justify-center rounded-full px-12 py-2 mb-5 bg-gradient-to-t from-[#172882] to-sky-400 text-white mt-2"
              >
                <FaGoogle className="mr-2" />
                Login with Google
              </button>
              <div className="text-xs md:text-sm text-center font-5 font-popin">
